...
public class EstudianteUI extends JFrame {
    ...
    private void guardar() {
        try {
            ...
            if (modo.equals("crear")) {
                ...
                System.out.println("[factory]--->estudiante creado: " + nombres);
                JOptionPane.showMessageDialog(this, "Estudiante agregado");
            } else {
                controller.editar(idEditando, nombres, edad);
                System.out.println("[factory]--->estudiante actualizado: " + nombres);
    ...
    class ButtonEditor extends AbstractCellEditor implements TableCellEditor {
        ...
        private void eliminarFila() {
            ...
            System.out.println("[factory]--->estudiante eliminado: " + id);
            mostrarTabla();
        }
